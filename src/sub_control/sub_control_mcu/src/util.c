 ...
 * util.c
 *
 * Ported verbatim from Nautical-Private src/util.c (unused local removed).
 *
...
void position_ned_to_body(struct mec_vehicle_position_body *body, struct mec_vehicle_position *ned,
...
void velocity_ned_to_body(struct mec_vehicle_velocity_body *body, struct mec_vehicle_velocity *ned,
                          struct mec_vehicle_attitude *att) {
...
void velocity_body_to_ned(struct mec_vehicle_velocity_body *body, struct mec_vehicle_velocity *ned,
                          struct mec_vehicle_attitude *att) {
