 ...
 *
 * Ported verbatim from Nautical-Private src/velocity_controller.c.
 *
 * Implements a PID controller to correct error in vehicle body velocity.
 * The outputs of this controller (force setpoints) are fed through the mixer
 *
